...
**Kiến thức về git**:
**1. Khởi tạo git và tạo repo trên github:**
...
- git remote add origin <URL_của_repo_ở_dạng_SSH>: Lưu địa chỉ github - 1 lần/repo
- git push -u origin <tên_nhánh>: Đẩy code lên - 1 lần/nhánh, sau đó chỉ cần `git push`
**2. Ba vùng trong git**
